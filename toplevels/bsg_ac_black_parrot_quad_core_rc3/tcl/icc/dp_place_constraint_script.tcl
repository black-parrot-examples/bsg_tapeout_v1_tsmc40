...
set bypass_bound [create_bounds -name "bypass_bound" -type soft -coordinate [list $bot_box $left_box $right_box]]
add_to_bound ${bypass_bound} [get_cells bypass_link]
add_to_bound ${bypass_bound} [get_cells bypass_router]
add_to_bound ${bypass_bound} [get_cells -hier -filter "full_name=~prev*repeater"]
add_to_bound ${bypass_bound} [get_cells -hier -filter "full_name=~next*repeater"]
...
update_bounds -name "next_ct" -add [get_cells -hier -filter "full_name=~*next*link*"]
update_bounds -name "next_ct" -add [get_cells -hier -filter "full_name=~*next*ct*"]
...
update_bounds -name "prev_ct" -add [get_cells -hier -filter "full_name=~*prev*link*"]
update_bounds -name "next_ct" -add [get_cells -hier -filter "full_name=~*prev*ct*"]
...
foreach_in_collection mim [get_plan_groups $ICC_MIM_MASTER_LIST] {
  ...
  if { $mim_master_name == "bp_tile_node" } {
    ...
    set_fp_relative_location -name cce_inst_ram_rl -target_cell [get_attribute $cce_inst_ram full_name] -target_orientation E -target_corner br -anchor_corner bl -anchor_object cce_dir_mem_array -x_offset -$macro_keepout -y_offset -$macro_keepout
