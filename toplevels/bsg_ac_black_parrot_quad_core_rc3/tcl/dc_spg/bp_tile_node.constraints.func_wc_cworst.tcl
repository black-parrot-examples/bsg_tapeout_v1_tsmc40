...
#
#bsg_set_general_timing_constraints bp_clk [get_ports "core_clk_i coh_clk_i"] 2.0 0.1 $core_input_ports $core_output_ports 0.4 16 INVD1BWP INVD8BWP
#bsg_set_general_timing_constraints mem_clk [get_ports mem_clk_i] 2.0 0.1 $mem_input_ports $mem_output_ports 0.4 16 INVD1BWP INVD8BWP
#
...
read_sdc ${DESIGN_NAME}_func_wc_cworst.sdc
