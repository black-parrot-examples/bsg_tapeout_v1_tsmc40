...
proc bsg_generic { clk_name clk_source clk_period clk_uncertainty input_ports output_ports max_transition max_capacitance max_fanout driving_cell load_cap } {
