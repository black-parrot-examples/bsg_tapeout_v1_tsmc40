...
proc bsg_set_general_timing_constraints { clk_name clk_source clk_period clk_uncertainty input_ports output_ports max_transition max_capacitance max_fanout driving_cell load_cap } {
  ...
  set_driving_cell -no_design_rule -lib_cell $driving_cell $input_ports
  set_load $load_cap $output_ports
