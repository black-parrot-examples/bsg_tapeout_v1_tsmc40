...
bsg_set_general_timing_constraints $CORE_CLK_NAME   [get_ports "core_clk_i coh_clk_i"] $CORE_CLK_PERIOD   0.1 $core_input_ports $core_output_ports 0.4 0.1 16 INVD1BWP 0.1
bsg_set_general_timing_constraints $ROUTER_CLK_NAME [get_ports mem_clk_i]              $ROUTER_CLK_PERIOD 0.1 $mem_input_ports  $mem_output_ports  0.4 0.1 16 INVD1BWP 0.1
