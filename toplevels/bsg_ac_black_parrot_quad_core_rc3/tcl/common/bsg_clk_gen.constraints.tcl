...
#
proc bsg_clk_gen_clock_create { clk_name clk_gen_period_int clk_gen_period_ext osc_uncertainty ds_uncertainty clk_uncertainty } {
  ...
  set osc_clk_pin [remove_from_collection -intersect [get_pins -leaf -of_objects [get_nets -hierarchical osc_clk_out] -filter "direction==out"] [all_fanin -to [get_nets ${clk_name}_lo] -flat]]
  create_clock -period $clk_gen_period_int -name ${clk_name}_osc $osc_clk_pin
  ...
  set ds_clk_pin [remove_from_collection -intersect [get_pins -leaf -of_objects [get_nets -hierarchical ds_clk_out] -filter "direction==out"] [all_fanin -to [get_nets ${clk_name}_lo] -flat]]
  create_clock -period $clk_gen_period_int -name ${clk_name}_osc_ds $ds_clk_pin
  ...
  set clk_pin [get_pins -leaf -of_objects [get_nets ${clk_name}_lo] -filter "pin_direction==out"]
  create_clock -period $clk_gen_period_ext -name ${clk_name} $clk_pin
