...
foreach_in_collection mim [get_plan_groups $ICC_MIM_MASTER_LIST] {
  ...
  if { $mim_master_name == "bp_tile_node" } {
    ...
    set fe_misc_mem_list [get_fp_cells -of_objects $mim -filter "is_hard_macro&&full_name=~*icache*stat_mem*"]
    append_to_collection fe_misc_mem_list [get_fp_cells -of_objects $mim -filter "is_hard_macro&&full_name=~*btb*"]
    append_to_collection fe_misc_mem_list [get_fp_cells -of_objects $mim -filter "is_hard_macro&&full_name=~*icache*tag_mem*"]
    set_fp_macro_options $fe_misc_mem_list -legal_orientations E
    set_fp_macro_array -name fe_misc_mem_array -elements $fe_misc_mem_list -align_edge t -use_keepout_margin
    set_fp_relative_location -name fe_misc_mem_array_rl -target_cell fe_misc_mem_array -target_corner tr -anchor_corner tl -anchor_object icache_data_mem_array

    set be_misc_mem_list [get_fp_cells -of_objects $mim -filter "is_hard_macro&&full_name=~*dcache*tag_mem*"]
    append_to_collection be_misc_mem_list [get_fp_cells -of_objects $mim -filter "is_hard_macro&&full_name=~*dcache*stat_mem*"]
    set_fp_macro_options $be_misc_mem_list -legal_orientations W
    set_fp_macro_array -name be_misc_mem_array -elements $be_misc_mem_list -align_edge t -use_keepout_margin
    set_fp_relative_location -name be_misc_mem_array_rl -target_cell be_misc_mem_array -target_corner tr -anchor_corner tl -anchor_object fe_misc_mem_array -x_offset [expr -60 * $macro_keepout]
    ...
    set_fp_relative_location -name dcache_data_mem_array_rl -target_cell dcache_data_mem_array -target_corner tr -anchor_corner tl -anchor_object be_misc_mem_array
